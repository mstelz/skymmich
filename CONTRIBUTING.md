# Contributing to Astromich

Thank you for your interest in contributing to Astromich! We welcome contributions from the community to help make this astrophotography management tool even better.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Astromich.git
   cd Astromich
   ```
...
By contributing to Astromich, you agree that your contributions will be licensed under the MIT License.
...
Thank you for contributing to Astromich! Your help makes this project better for the entire astrophotography community.